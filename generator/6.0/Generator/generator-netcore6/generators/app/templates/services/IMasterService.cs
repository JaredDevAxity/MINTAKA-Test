// <summary>
// <copyright file="I[%= controllerName %]Service.cs" company="Axity">
...
namespace [%= company %].[%= name %].Services.[%= controllerName %]
{
    /// <summary>
...
[% } %][% if (controllerPost) { %]
        ...
        /// <param name="Create[%= singularControllerName %]Dto">Object to insert.</param>
        /// <returns>A <see cref="Task{[%= singularControllerName %]Dto}"/> representing the result of the asynchronous operation.</returns>
...
[% } %][% if (controllerPut) { %]
        ...
        /// <param name="Update[%= singularControllerName %]Dto">Object to update.</param>
        /// <returns>A <see cref="Task{[%= singularControllerName %]Dto}"/> representing the result of the asynchronous operation.</returns>
